...
//        /// <returns></returns>
//        public override Task<WebSocketClient> ConnectAsync(Uri uri)
//        {
...
//            this._wsClient = new ws4net.WebSocket(uri.ToString());
...
//            this._wsClient.Opened += HandlerOpen;
//            this._wsClient.Closed += HandlerClose;
//            this._wsClient.MessageReceived += HandlerMessage;
//            this._wsClient.DataReceived += HandlerData;
...
//        {
//            if (this._wsClient.State != ws4net.WebSocketState.Closed)
...
//        {
//            if (this._wsClient.State == ws4net.WebSocketState.Open)
